...
const Carousel: React.FC<CarouselProps> = ({
  ...
  return (
    ...
    boxShadow: "none", // ⬅️ forcefully remove shadow
    filter: "none",     // ⬅️ in case there's a blur/glow filter
    outline: "none",    // ⬅️ remove any outline
    border: "none",     // ⬅️ just to be extra sure
  }}
        />
      </RevealFx>
      {images.length > 1 && (
